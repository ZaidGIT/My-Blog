  ...
  return (
    <div className="home-container">
      ...
      <div className="content-container">
        <div className="title">
          <h2>Enginuity -</h2>
          <h3>Engineering Talent & Project Matching Platform</h3>
        ...
        <div className="title">
          ...
          <h3>Real Time Occupancy Insights</h3>
        ...
        <div className="title">
          ...
          <h3>A Comparative Study of GANs and Diffusion</h3>
          <span className="date">Sun, Sep 8, 2024</span>
          <p className="content">
